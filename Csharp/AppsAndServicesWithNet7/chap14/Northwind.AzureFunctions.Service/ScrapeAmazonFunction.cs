...
public class ScrapeAmazonFunction
{
    ...
    public ScrapeAmazonFunction(IHttpClientFactory httpClientFactory)
    {
    ...
    public async Task Run( // every hour
        ...
        ILogger log)
    {
        log.LogInformation($"C# Timer trigger function executed at {System.DateTime.UtcNow}");
        log.LogInformation("C# Timer trigger function next three occurrences at: " +
