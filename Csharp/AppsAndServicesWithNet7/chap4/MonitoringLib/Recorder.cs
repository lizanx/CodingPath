...
public static class Recorder
{
    ...
    public static void Stop()
    {
        ...
        WriteLine("{0:N0} bytes physical memory used.",
            bytesPhysicalAfter - bytesPhysicalBefore);
        WriteLine("{0:N0} bytes virtual memory used.",
            bytesVirtualAfter - bytesVirtualBefore);
        
        WriteLine("{0} time span elapsed, {1:N0} milliseconds in total.",
            timer.Elapsed, timer.ElapsedMilliseconds);
    }
}
