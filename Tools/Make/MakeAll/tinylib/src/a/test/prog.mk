...
description := Test library component a (a1 + a2), and extra object
$(print-description)
...
# this program depends on 2 objects: a and extra
$(eval $(call include-once, $(lib_src_dir)/a/obj.mk     ))
$(eval $(call include-once, $(lib_src_dir)/a/test/obj.mk))
...
this_src_dir := $(lib_src_dir)/a/test
