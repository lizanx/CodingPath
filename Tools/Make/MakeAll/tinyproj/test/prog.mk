...
description := Test $(proj_name) project
$(print-description)
...
# $(eval $(call include-once, $(proj_src_dir)/xyz/obj.mk))

# this program depends on 2 objects: x and y
$(eval $(call include-once, $(proj_src_dir)/x/obj.mk))
...
this_src_dir := $(proj_base_dir)/test
